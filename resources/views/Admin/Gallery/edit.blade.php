        ...
        <div class="row">
            <div class="col-12">
                <div class="card basic-form">
                    <div class="card-body">
                        <h3 class="text-22 text-midnight text-bold mb-4">Gallery Edit </h3>
                        @if ($errors->any())
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" required class="form-control " value="{!! $Gallery->title !!}"
                                               name="title">
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="file" class="form-control dropify" value=" " name="image">
                                    </div>
                                </div>
                            </div>
