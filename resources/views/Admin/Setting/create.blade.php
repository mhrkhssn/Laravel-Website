                    ...
                    <div class="row">
                        <div class="col-3">
                            <div class="form-group">
                                ...
                                <input required type="text" required class="form-control" value=" " name="name">
                            </div>
                        </div>
                        <div class="col-3">
                            <div class="form-group">
                                ...
                                <input required type="text" required class="form-control " value="" name="type">
                            </div>
                        </div>
                        <div class="col-3">
                            <div class="form-group">
                    ...
                    <div class="row mt-5">
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <textarea required class="form-control" name="value"></textarea>
                            </div>
                        </div>
                    </div>
